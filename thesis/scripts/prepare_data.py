#!/usr/bin/env python3
"""Canonical thesis data-prepare entrypoint."""
...
from thesis.runtime import CANONICAL_RUNTIME_FAMILY, prepare_thesis_run
from thesis.scripts._common import parse_sequences, repo_root_from_script


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Prepare canonical thesis datasets and validate raw contracts."
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.2,
        help="Train/val split ratio for dataset generation.",
    )
...
def main() -> None:
    ...
    print(f"Prepare completed for run: {paths.run_dir}")
